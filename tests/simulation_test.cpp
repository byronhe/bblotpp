...
void testSimulate(int round, int threadCount, int parallelism) {
  ...
  auto [db, err] = bboltpp::DB::Open("test_simulation.db", 0644, nullptr);
  EXPECT_TRUE(err.OK());
  ...
  for (int n = 0; n < round; n++) {
    ...
    db->Close();
    bboltpp::RemoveFile("test_simulation.db");

    // Reopen for next round
    auto [newDb, newErr] = bboltpp::DB::Open("test_simulation.db", 0644, nullptr);
...
TEST_F(SimulationTest, TestSimulate_1op_1p) {
  std::cout << "Running TestSimulate_1op_1p..." << std::endl;
  testSimulate(1, 1, 1);
  std::cout << "TestSimulate_1op_1p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_10op_1p) {
  std::cout << "Running TestSimulate_10op_1p..." << std::endl;
  testSimulate(1, 10, 1);
  std::cout << "TestSimulate_10op_1p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_100op_1p) {
  std::cout << "Running TestSimulate_100op_1p..." << std::endl;
  testSimulate(1, 100, 1);
  std::cout << "TestSimulate_100op_1p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_1000op_1p) {
  std::cout << "Running TestSimulate_1000op_1p..." << std::endl;
  testSimulate(1, 1000, 1);
  std::cout << "TestSimulate_1000op_1p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_10000op_1p) {
  std::cout << "Running TestSimulate_10000op_1p..." << std::endl;
  testSimulate(1, 10000, 1);
  std::cout << "TestSimulate_10000op_1p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_10op_10p) {
  std::cout << "Running TestSimulate_10op_10p..." << std::endl;
  testSimulate(1, 10, 10);
  std::cout << "TestSimulate_10op_10p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_100op_10p) {
  std::cout << "Running TestSimulate_100op_10p..." << std::endl;
  testSimulate(1, 100, 10);
  std::cout << "TestSimulate_100op_10p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_1000op_10p) {
  std::cout << "Running TestSimulate_1000op_10p..." << std::endl;
  testSimulate(1, 1000, 10);
  std::cout << "TestSimulate_1000op_10p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_10000op_10p) {
  std::cout << "Running TestSimulate_10000op_10p..." << std::endl;
  testSimulate(1, 10000, 10);
  std::cout << "TestSimulate_10000op_10p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_100op_100p) {
  std::cout << "Running TestSimulate_100op_100p..." << std::endl;
  testSimulate(1, 100, 100);
  std::cout << "TestSimulate_100op_100p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_1000op_100p) {
  std::cout << "Running TestSimulate_1000op_100p..." << std::endl;
  testSimulate(1, 1000, 100);
  std::cout << "TestSimulate_1000op_100p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_10000op_100p) {
  std::cout << "Running TestSimulate_10000op_100p..." << std::endl;
  testSimulate(1, 10000, 100);
  std::cout << "TestSimulate_10000op_100p passed" << std::endl;
}

TEST_F(SimulationTest, TestSimulate_10000op_1000p) {
  std::cout << "Running TestSimulate_10000op_1000p..." << std::endl;
  testSimulate(1, 10000, 1000);
  std::cout << "TestSimulate_10000op_1000p passed" << std::endl;
}
